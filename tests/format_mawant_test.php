...
/**
 * mawang course format related unit tests.
 *
 * @package    format_mawang
 * @copyright  2025 Bas Brands
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 * @covers     \format_mawang
 */
final class format_mawang_test extends \advanced_testcase {
    ...
    /**
     * Tests for format_mawang::get_section_name method with default section names.
     */
    public function test_get_section_name(): void {
        ...
        $numsections = 5;
        $course = $generator->create_course(['numsections' => $numsections, 'format' => 'mawang'],
            ['createsections' => true]);
    ...
    /**
     * Tests for format_mawang::get_section_name method with modified section names.
     *
     * @return void
     */
    ...
    /**
     * Tests for format_mawang::get_default_section_name.
     *
     * @return void
     */
    public function test_get_default_section_name(): void {
        ...
        foreach ($coursesections as $section) {
            if ($section->section == 0) {
                $sectionname = get_string('section0name', 'format_mawang');
                $this->assertEquals($sectionname, $courseformat->get_default_section_name($section));
            } else {
                $sectionname = get_string('sectionname', 'format_mawang') . ' ' . $section->section;
                $this->assertEquals($sectionname, $courseformat->get_default_section_name($section));
            }
        }
    }
    ...
    public function test_update_inplace_editable(): void {
        ...
        $this->setUser($user);
        $course = $this->getDataGenerator()->create_course(['numsections' => 5, 'format' => 'mawang'],
            ['createsections' => true]);
        $section = $DB->get_record('course_sections', ['course' => $course->id, 'section' => 2]);

        // Call webservice without necessary permissions.
        try {
            core_external::update_inplace_editable('format_mawang', 'sectionname', $section->id, 'New section name');
        ...
        $res = core_external::update_inplace_editable('format_mawang', 'sectionname', $section->id, 'New section name');
    ...
    public function test_inplace_editable(): void {
        ...
        // Call callback format_mawang_inplace_editable() directly.
        $tmpl = component_callback('format_mawang', 'inplace_editable',
    ...
    public function test_default_course_enddate(): void {
        ...
        $params = ['format' => 'mawang', 'numsections' => 5, 'startdate' => 1445644800];
    ...
    /**
     * Tests for format_mawang::delete_section_with_children.
     */
