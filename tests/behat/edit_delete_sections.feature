...
Feature: Sections can be edited and deleted in mawang sections format
  ...
  Background:
    ...
    And the following "courses" exist:
      ...
      | Course 1 | C1        | mawang | 0             | 5           | 1            |
      | Course 2 | C2        | mawang | 0             | 1           | 0            |
  ...
  Scenario: View the default name of the general section in mawang sections format
    Given I am on "Course 1" course homepage with editing mode on
    When I edit the section "0"
    Then the field "Section name" matches value ""
    And I should see "General"

  Scenario: Edit the default name of the general section in mawang sections format
    Given I am on "Course 1" course homepage with editing mode on
  ...
  Scenario: View the default name of the second section in mawang sections format
  ...
  Scenario: Edit section default name in mawang sections format
    Given I am on "Course 1" course homepage with editing mode on
    When I edit the section "2" and I fill the form with:
  ...
  @javascript
  Scenario: Inline edit section name in mawang sections format
    Given I am on "Course 1" course homepage with editing mode on
  ...
  Scenario: Deleting the last section in mawang sections format
    Given I am on "Course 1" course homepage with editing mode on
  ...
  Scenario: Deleting the middle section in mawang sections format
    Given I am on "Course 1" course homepage with editing mode on
