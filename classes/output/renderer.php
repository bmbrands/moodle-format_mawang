...
use format_mawang_edit_control;
use html_writer;
use moodle_page;
use pix_icon;
use section_info;
...
class renderer extends section_renderer {
    ...
    public function __construct(moodle_page $page, $target) {
        ...
        // Since format_mawang_renderer::section_edit_control_items() only displays the 'Highlight' control
    ...
    public function course_index_drawer(course_format $format): ?String {
        if ($format->uses_course_index()) {
            ...
            return $this->render_from_template('format_mawang/local/courseindex/drawer', []);
        }
        return '';
    }
}
