    ...
    public function section_control_items() {
        ...
        if (has_capability('moodle/course:update', $coursecontext) && $section->section &&
            ...
            $controls['addsubsection'] = [
                ...
                'icon' => 't/add',
                'name' => get_string('addsubsection', 'format_mawang'),
                'pixattr' => ['class' => ''],
                'attr' => [
                    'class' => 'editing_addsubsection',
                    'data-action-mawang' => 'addSubSection',
        ...
        $section->section != $this->format->get_viewed_section()) {
            ...
            $attrs = [
                'data-action-mawang' => 'sectionSwitchCollapsed',
            ...
            if ($section->collapsed == FORMAT_mawang_COLLAPSED) {
                $controls['collapsed'] = [
                    'url' => $collapseurl,
                    'icon' => 't/expanded',
                    'name' => get_string('showexpanded', 'format_mawang'),
                    'pixattr' => ['class' => ''],
                    'attr' => $attrs,
                ];
            } else {
                $controls['collapsed'] = [
                    'url' => $collapseurl,
                    'icon' => 't/collapsed',
                    'name' => get_string('showcollapsed', 'format_mawang'),
                    'pixattr' => ['class' => ''],
                    'attr' => $attrs,
                ];
            }
        ...
        if ($section->parent && has_capability('moodle/course:update', $coursecontext) &&
            ...
            $controls['mergeup'] = [
                'url' => $mergeupurl,
                'icon' => 'mergeup',
                'iconcomponent' => 'format_mawang',
                'name' => get_string('mergeup', 'format_mawang'),
                'pixattr' => ['class' => ''],
                'attr' => [
                    'class' => 'editing_mergeup',
                    'data-action-mawang' => 'mergeup',
                    'data-id' => $section->id,
                ],
            ];
        }
        ...
        if (has_capability('moodle/course:update', $coursecontext) && $section->section &&
            ...
            $controls['movemawang'] = [
                ...
                'pixattr' => ['class' => ''],
                'attr' => [
                    'data-action-mawang' => 'moveSection',
                    'data-id' => $section->id,
        ...
        if ($section->section == $this->format->get_viewed_section()) {
            ...
            $parentcontrols['delete']['attr']['data-action-mawang'] = 'delete';
        }
