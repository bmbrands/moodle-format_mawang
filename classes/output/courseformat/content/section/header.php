...
class header extends \core_courseformat\output\local\content\section\header {
    ...
    public function get_template_name(\renderer_base $renderer): string {
        return 'format_mawang/local/content/section/header';
    }
    ...
    public function export_for_template(\renderer_base $output): \stdClass {
        ...
        if ($this->section->collapsed == FORMAT_mawang_COLLAPSED) {
    ...
    protected function title_needs_indenting(): bool {
        $hassections = [FORMAT_mawang_COLLAPSED => false, FORMAT_mawang_EXPANDED => 0];
        ...
        return $hassections[FORMAT_mawang_EXPANDED] && $hassections[FORMAT_mawang_COLLAPSED];
    }
}
