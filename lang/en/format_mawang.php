...
$string['lessonstitle'] = 'Lessons section title';
$string['lessonstitle_help'] = 'The heading shown above the list of sections (lessons) on the course page. Leave blank to use the default ("Lessons").';
