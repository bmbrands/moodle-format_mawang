 ...
 *
 * @module     format_mawang/local/courseindex/courseindex
...
export default class Component extends BaseCourseindex {
    ...
    create(descriptor) {
        ...
        this.name = 'course_format_mawang_courseindex';
    ...
    async _createSection({state, element}) {
        ...
        const newcomponent = await this.renderComponent(sectionItem, 'format_mawang/local/courseindex/section', data);
